<template>
  <b-modal
    v-model="showModal"
    :id="`editBusinessUnit-${businessUnit._id}`"
    :title="$t('datastructure.edit_business_unit')"
    body-bg-variant="100"
  ...
  >
    ...
    <div slot="modal-footer">
      <save-button
        :disabled="editBusinessUnit.name && editBusinessUnit.name.length < 1"
        @click="updateBusinessUnit()"
